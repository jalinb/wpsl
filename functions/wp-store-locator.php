...
function custom_meta_box_fields( $meta_fields ) {
    ...
    $meta_fields[__( 'Additional Information', 'wpsl' )] = array(
        ...
        'coming_soon' => array(
            'label' => __( 'Coming Soon Text', 'wpsl' )
        ),
        'description' => array(
...
function custom_listing_template() {
    ...
    $listing_template .= "\t\t\t\t" . '<div class="col-12 community-title px-4"><h3 class="color-tertiary mb-2"><%= store %> <% if ( coming_soon ) { %><stong class="d-block dark small font-weight-bold"><%= coming_soon %></stong><% } %></h3><% if ( description ) { %><p><%= description %></p><% } %></div>' . "\r\n";
